...
```
HAMMING CODE TESTER (NETWORKING)
BY github.com/sharadcodes
ENTER THE DATA WITH EVEN PARITY ( A 7 bit data like: 1011011 ) : 1011011
...
========================
 CHECKING PARITY FOR P4
========================

BITS ARE : 1 1 0 1

For P4 the number of 1s are odd setting P4 = 1


========================
 CHECKING PARITY FOR P2
========================

BITS ARE : 1 0 0 1

For P2 the number of 1s are even setting P2 = 0


========================
 CHECKING PARITY FOR P1
========================

BITS ARE : 1 0 1 1

For P1 the number of 1s are odd setting P1 =  1


==========================

INCOORECT BIT IS AT 5                                                                                                                                                                           
